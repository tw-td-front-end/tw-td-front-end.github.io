var VueObserver = (function (exports) {
  ...
  function createInstrumentationGetter (instrumentations) {
    return function getInstrumented (target, key, receiver) {
      target = hasOwn (instrumentations, key) && key in target
        ? instrumentations
        : target;
  ...
  window.rawToReactive = rawToReactive;
  window.reactiveToRaw = reactiveToRaw;
  window.rawToReadonly = rawToReadonly;
  window.readonlyToRaw = readonlyToRaw;
  window.readonlyValues = readonlyValues;
  window.nonReactiveValues = nonReactiveValues;
  window.collectionTypes = collectionTypes;
