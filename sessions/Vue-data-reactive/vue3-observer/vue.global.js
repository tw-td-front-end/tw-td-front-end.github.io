var Vue = (function (exports) {
   ...
   */
  const SVG_TAGS = 'svg,animate,circle,clippath,cursor,defs,desc,ellipse,filter,font-face,' +
  ...
  function buildProps(node, context, props = node.props) {
      ...
      const analyzePatchFlag = ({ key, value }) => {
          if (key.type === 4 /* SIMPLE_EXPRESSION */ && key.isStatic) {
              if (value.type === 19 /* JS_CACHE_EXPRESSION */ ||
